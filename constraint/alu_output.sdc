...
#  Created by Genus(TM) Synthesis Solution 20.11-s111_1 on Fri Oct 17 14:49:07 IST 2025
...
set_input_delay -clock [get_clocks clk] -add_delay 2.0 [get_ports {op_code[2]}]
set_input_delay -clock [get_clocks clk] -add_delay 2.0 [get_ports {op_code[1]}]
set_input_delay -clock [get_clocks clk] -add_delay 2.0 [get_ports {op_code[0]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 2.0 [get_ports flag_carry]
set_output_delay -clock [get_clocks clk] -add_delay 2.0 [get_ports flag_zero]
